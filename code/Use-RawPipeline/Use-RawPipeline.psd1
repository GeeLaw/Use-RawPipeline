...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://github.com/GeeLaw/Use-RawPipeline/blob/master/LICENSE.md'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/GeeLaw/Use-RawPipeline'

        # A URL to an icon representing this module.
        # IconUri = ''

        # ReleaseNotes of this module
        ReleaseNotes = 'Recreated for better performance.'
...
HelpInfoURI = 'https://github.com/GeeLaw/Use-RawPipeline'

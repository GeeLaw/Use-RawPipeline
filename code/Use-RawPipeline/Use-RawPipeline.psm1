...
{
    [CmdletBinding(HelpUri = 'https://github.com/GeeLaw/Use-RawPipeline')]
    Param
    (
...
{
    [CmdletBinding(HelpUri = 'https://github.com/GeeLaw/Use-RawPipeline', DefaultParameterSetName = 'CreateProcess')]
    Param
    (
...
{
    [CmdletBinding(HelpUri = 'https://github.com/GeeLaw/Use-RawPipeline', DefaultParameterSetName = 'CommonEncoding')]
    Param
    (
